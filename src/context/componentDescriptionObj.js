export const compDescriptionsObj = {
  ...
  DragAndDrop: {
    ...
    inBeta: true,
    accessibility:
      'Accessibility features and descriptions in beta. Not yet keyboard accessible.',
  },
  GenerateOTP: {
    desc: 'A component for generating random one-time passwords(OTPs).',
    feats: ['Generates and regenerates random OTP.', 'Ability to copy OTP.'],
    inBeta: false,
    accessibility: 'Keyboard accessible.',
  },
  InputFile: {
    desc: "A component for uploading files selected from users' devices.",
    feats: ['Can upload one file from the device storage of the user.'],
    inBeta: false,
  ...
  InputOTP: {
    ...
    inBeta: true,
    accessibility:
      'Includes appropriate ARIA attributes and semantic. Not fully keyboard accessible.',
  },
  SearchButton: {
  ...
  ToDoList: {
    ...
    inBeta: false,
    accessibility:
      'Includes focus states and contrast considerations. Not fully keyboard accessible.',
  },
  Switch: {
    desc: 'A component that toggles between light and dark mode.',
    feats: ['Toggle switch that toggles left and right'],
    inBeta: false,
    accessibility:
      'The component uses a cursor pointer and has an accessible label. Not fully keyboard accessible.',
  },
};
