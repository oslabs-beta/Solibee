...
export default function ContentComponent() {
  ...
  const copyToClipboard = () => {
    ...
    // You may want to provide feedback to the user that the text has been copied, for example, by showing a toast message or changing the button text temporarily.
  };
      ...
      <div class='my-5 flex flex-col space-y-4'>
        ...
        <div class='w-full'>
          ...
          <div class='relative w-full'>
            <button class='absolute bottom-2 right-2 w-0.5 h-0.5 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded' onClick={copyToClipboard}>
            </button>
