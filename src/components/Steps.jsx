...
export default function Steps() {
  ...
  return (
    <>
      ...
      >
        <p
          class="step-counter font-heading relative mt-8 pl-10 text-xl
  font-semibold tracking-tight before:absolute before:left-0 before:z-10 before:z-20 before:flex before:h-[calc(1.375rem+1px)] before:w-[calc(1.375rem+1px)] before:items-center before:justify-center before:rounded-md
before:text-[0.9rem] before:font-bold before:text-slate-700 before:shadow-md before:ring-2 before:ring-slate-900/5 before:content-[counter(step)]"
        ...
        <div class="relative w-full">
          ...
          <button class='inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 z-10 h-6 w-6 text-zinc-50 hover:bg-zinc-700 hover:text-zinc-50 absolute right-4 top-4'>
            ...
            <pre
              class="shiki rose-pine"
              style="background-color:#191724;color:#e0def4"
              tabindex="0"
            >
              <code>
...
before:text-[0.9rem] before:font-bold before:text-slate-700 before:shadow-md before:ring-2 before:ring-slate-900/5 before:content-[counter(step)]"
        ...
        <div>{console.log(typeof textToCopy())}</div>
