    ...
    <article class="prose max-w-[800px] mx-auto w-10/12 bg-white/[0.9]">
      <header>
        ...
        <p>
          ...
          components for Solid.JS. Solibee has easily integratable components: See a component you like? Copy and paste the code
          into your project!
        </p>
      </header>
      ...
      <section class="mt-8">
        {/* font-bold  mb-4 */}
        <h2 class=" border-b mb-2 text-2xl font-bold">Features</h2>
      ...
      <section class="mt-8">
        <h2 class="font-bold text-2xl mb-4 border-b" >Questions/Community</h2>
        <subsection >
          ...
          reach out or contribute to our project by sending a PR to <a href="https://github.com/oslabs-beta/Solibee" target="_blank" class ="underline underline-offset-2 transition-colors hover:text-orange-200" rel = "noopener noreferrer"> our GitHub. </a>
        </subsection>
      </section>
      ...
      <section class="mt-8">
        ...
        <ul class="list-disc list-inside">
          ...
          <li><a href="https://corvu.dev/" target="_blank" class ="solibee-link" rel = "noopener noreferrer">corvu.dev/ </a></li>
        </ul>
      </section>
