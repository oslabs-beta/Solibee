  ...
  return (
    <p
      ...
      class='step-counter relative mt-8 pl-10 text-xl
             font-medium tracking-tight before:absolute before:left-0 before:z-20 before:flex before:h-[calc(1.375rem+1px)] before:w-[calc(1.375rem+1px)] before:items-center before:justify-center before:rounded-md
